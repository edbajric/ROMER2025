# this one calibrates the camera using the already saved images from the chessboard
# it saves the calibration data and undistorted images
# it uses OpenCV for camera calibration



# !!!!!!!!!!!!!!:
# use realsense_r200_capture_image.py to capture images for calibration
...
CALIBRATION_IMAGES_PATH = 'calibration_images2/*.jpg'  # Path to calibration images
